...
!(function(t, e) {
            ...
            if (Array.isArray(r)) {
              ...
              return (
                r.forEach(function(t) {
                  void 0 !== t &&
                    (null === t ? n.push(Pt(e)) : n.push(Pt(e) + '=' + Pt(t)));
                }),
                n.join('&')
              );
            }
  ...
  function E(t) {
    ...
    return function(r, n) {
      for (
        var o = '',
          i = r || {},
          a = (n || {}).pretty ? k : encodeURIComponent,
          u = 0;
        u < t.length;
        u++
      ) {
        ...
        if ('string' != typeof c) {
          ...
          if (Ft(p)) {
            ...
            if (((s = c.asterisk ? R(p) : a(p)), !e[u].test(s)))
              throw new TypeError(
                'Expected "' +
                  c.name +
                  '" to match "' +
  ...
  function z(t, e) {
    function r(t, r, n) {
      ...
      if (a) {
        ...
        if (u)
          return (
            (o.path = L(u.path, o.params, 'named route "' + a + '"')),
            i(u, o, n)
          );
      } else if (o.path) {
        o.params = {};
  ...
  function nt(t, e) {
    ...
    try {
      e
        ? r.replaceState({ key: Zt }, '', t)
        : ((Zt = tt()), r.pushState({ key: Zt }, '', t));
    } catch (r) {
  ...
  var re = (function(t) {
    ...
    ie = function(t) {
      ...
      var e = t.mode || 'hash';
      switch (
        ((this.fallback = 'history' === e && !Wt && !1 !== t.fallback),
  ...
  return (
    (ie.prototype.match = function(t, e, r) {
