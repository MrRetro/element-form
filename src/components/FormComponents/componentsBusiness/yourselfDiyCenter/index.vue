...
export default {
  ...
  computed: {
    ...
    newOptions () {
      ...
      try {
        list = list.filter(v => !['YourselfDiy', 'YourselfDiyLeft', 'YourselfDiyCenter', 'YourselfDiyRight', 'Layout', 'Line', 'Button', 'Transfer', 'Upload'].includes(v.type))
      } catch (e) {
        console.log('err==>', e)
      }
      return list
